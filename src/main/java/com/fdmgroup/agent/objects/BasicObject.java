...
public abstract class BasicObject implements UseableObject {
	...
	/* (non-Javadoc)
	 * @see com.fdmgroup.agent.objects.UseableObject#advertiseActions()
	 */
	...
	/* (non-Javadoc)
	 * @see com.fdmgroup.agent.objects.UseableObject#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see com.fdmgroup.agent.objects.UseableObject#isBeingUsed()
	 */
	...
	/* (non-Javadoc)
	 * @see com.fdmgroup.agent.objects.UseableObject#setBeingUsed(boolean)
	 */
