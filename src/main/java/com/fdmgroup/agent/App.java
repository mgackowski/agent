...
public class App 
{
    ...
    {
    	/*Add two agents*/
        AgentPool.getInstance().addAgent(new Agent("Bob", new BasicIndividuality(1.3f, 0.22f)));
        AgentPool.getInstance().addAgent(new Agent("Alice", new BasicIndividuality(1.1f, 0.16f)));
        /*Add a fridge*/
