...
public abstract class BasicAction implements Action{
	...
	/* (non-Javadoc)
	 * @see com.mgackowski.agent.actions.Action#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see com.mgackowski.agent.actions.Action#getPromises()
	 */
	...
	/* (non-Javadoc)
	 * @see com.mgackowski.agent.actions.Action#getConsequences()
	 */
	...
	/* (non-Javadoc)
	 * @see com.mgackowski.agent.actions.Action#getConsequence(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.mgackowski.agent.actions.Action#getNextAction()
	 */
