 ...
 *
 */
public abstract class BasicIndividuality {
	
	protected Map<String,Float> downRate = new HashMap<String,Float>();

	/**
	 * @param The name of the need. The suggested format is ALLCAPS e.g. "HUNGER".
	 * @return The modifier of speed at which the given need will deteriorate (1 is default, 2 is twice the speed etc.).
	 */
